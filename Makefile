...
qwen2: src/models/qwen2/qwen2.cu
	$(CC) --shared -DLINEAR_DEBU -DARGMAX_DEBU -Xcompiler -fPIC --std=c++20 -o qwen2_fp16.so -O3 src/models/qwen2/qwen2.cu -I./ -lm -lcublas -lcublasLt  -gencode arch=compute_80,code=sm_80 

qwen2_cpp: src/models/qwen2/qwen2.cpp
	g++ --shared -DLINEAR_DEBU -D ARGMAX_DEBU -fPIC --std=c++20 -o qwen2_fp32.so -O4 src/models/qwen2/qwen2.cpp -I./ -lm -fopenmp
...
cublas_W8A8: qwen2_cublas_W8A8.cu
	$(CC) --shared -Xcompiler -fPIC -o qwen2_q80.so -O3 qwen2_cublas_W8A8.cu -lm -lcublas -lcublasLt -gencode arch=compute_80,code=sm_80 

v2: qwen2_v2.cu
	$(CC) --shared -Xcompiler -fPIC -o qwen2_fp16.so -O3 qwen2_v2.cu -lm -lcublas -lcublasLt -gencode arch=compute_80,code=sm_80

v3: qwen2_v3.cu
	$(CC) --shared -Xcompiler -fPIC -o qwen2_fp16.so -O3 qwen2_v3.cu -lm -lcublas -lcublasLt -gencode arch=compute_80,code=sm_80


v0: qwen2_v0.cu
	$(CC) --shared -Xcompiler -fPIC -o qwen2_fp16.so -O3 qwen2_v0.cu -lm -gencode arch=compute_80,code=sm_80
