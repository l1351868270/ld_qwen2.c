...
async def create_chat_completion(request: ChatCompletionRequest):
    ...
    tokenized_prompt, seq_len = model.tokenized_prompt(query)
    response, _ = model.chat(tokenized_prompt, seq_len)
    # response = "Hello, I am a helpful assistant. How can I help you today?"
